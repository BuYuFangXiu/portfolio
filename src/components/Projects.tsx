...
const projects: Project[] = [
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v2/ac_rpg_demo.mp4',
    details: [
  ...
  },
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v2/yunyu_demo.mp4',
    details: [
