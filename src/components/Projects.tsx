...
const projects: Project[] = [
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v3/ac_rpg_hq.mp4',
    details: [
  ...
  },
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v3/yunyu_merged.mp4',
    details: [
