...
const projects: Project[] = [
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v1/ac_rpg_demo.mp4',
    details: [
  ...
  },
  {
    ...
    video: 'https://github.com/BuYuFangXiu/portfolio/releases/download/videos-v1/yunyu_.mp4',
    details: [
